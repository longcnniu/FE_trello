    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/api/user/signup',
                { 'username':user, 'password': pwd, 'firstname': firstname, 'lastname':lastname, 'email':email },
                {
                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <label htmlFor="firstname">
                            ...
                            <FontAwesomeIcon icon={faTimes} className={validLastname || !firstname ? "hide" : "invalid"} />
                        </label>
                        <input
                            type="text"
                            id="firstname"
                        ...
                        <button disabled={!validName || !validPwd || !validMatch || !validFirstname || !validLastname || !validEmail ? true : false}>Sign Up</button>
                    </form>
                    <p>
